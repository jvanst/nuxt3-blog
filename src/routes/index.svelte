...
<div class="relative" style="height: 500px">
  ...
  <div class="absolute w-full text-center mt-6 z-10">
    <a href="blog" rel="prefetch" class="p-2 bg-pink-700 items-center text-indigo-100 leading-none rounded-full flex inline-flex mx-auto shadow-lg" role="alert">
      <span class="flex rounded-full bg-pink-500 uppercase px-2 py-1 text-xs font-bold mr-3">New</span>
      <span class="font-semibold mr-2 text-left flex-auto">Read my development blog</span>
      ...
      <div class="w-full sm:w-1/2">
        <ul class="mt-6 mx-5">
          <li>
            <div class="flex">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/vuejs.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
                <div class="text-lg">Vue.js, Svelte & React</div>
          ...
          <li>
            <div class="flex mt-3">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/nodejs.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
                <div class="text-lg">NodeJs & PHP</div>
          ...
          <li>
            <div class="flex mt-3">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/api.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
                <div class="text-lg">RESTful JSON</div>
          ...
          <li>
            <div class="flex mt-3">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/database.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
                <div class="text-lg">MySQL</div>
          ...
          <li>
            <div class="flex mt-3">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/kubernetes.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
                <div class="text-lg">Kubernetes & Docker</div>
          ...
          <li>
            <div class="flex mt-3">
              <div class="flex-shrink mr-4 mt-2">
                <img src="./icons/git.svg" class="w-8" alt="vuejs">
              </div>
              <div class="flex-none">
