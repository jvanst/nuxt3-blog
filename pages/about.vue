      ...
      <div class="relative max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 lg:grid lg:grid-cols-3 lg:gap-8">
          <div class="hidden lg:block relative lg:row-start-1 lg:col-start-3">
            ...
            <div class="relative text-base text-center mx-auto max-w-prose lg:max-w-none">
          ...
          <div class="mt-8 lg:mt-0 prose dark:prose-invert col-span-2 space-y-3">
            <p>
              I'm a software developer located in Southwestern Ontario, Canada. My passion is building modern,
              highly scalable web applications with Typescript using
              <a
