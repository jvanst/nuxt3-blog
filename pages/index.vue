    ...
    <div class="relative pt-8 pb-20">
      ...
      <div class="relative max-w-7xl mx-auto">
        <div class="text-center">
          <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl">My Blog</h2>
          <p
            ...
            <div class="flex-1 p-6 flex flex-col justify-between">
              <div class="flex-1">
                <div class="block">
                  ...
                  <p class="text-xl font-semibold text-gray-900 dark:text-gray-100 mt-2">{{ post.title }}</p>
